        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center space-x-2">
            <Switch
              ...
              onCheckedChange={(checked) => setFormData({ ...formData, isAIPowered: checked })}
              disabled={isSubmitting}
            />
          ...
          {mode === 'edit' && formData.isAIPowered && (
            <div className="p-4 bg-blue-50 rounded-lg">
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="font-medium text-blue-900">Illustration Generation</h4>
                  <p className="text-sm text-blue-700">
                    Your wizard&apos;s illustration will be automatically regenerated when you save changes to the name or description.
                  </p>
                </div>
                <Button
                  type="button"
