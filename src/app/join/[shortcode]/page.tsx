      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-indigo-100 dark:from-purple-950 dark:via-slate-900 dark:to-indigo-950 flex items-center justify-center">
        <div className="text-center">
          <div className="relative mb-6">
            ...
            <div className="absolute inset-0 rounded-full h-12 w-12 border-4 border-transparent border-t-purple-400/60 dark:border-t-purple-300/60 animate-spin mx-auto" style={{ animationDirection: 'reverse', animationDuration: '1.5s' }}></div>
          </div>
          <div className="bg-card/90 dark:bg-card/95 backdrop-blur-sm border border-border/50 dark:border-border/30 rounded-xl px-6 py-4 shadow-lg dark:shadow-xl">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <p className="text-foreground dark:text-foreground/95 font-medium">Loading...</p>
            </div>
            <p className="text-muted-foreground dark:text-muted-foreground/80 text-sm">Preparing to join duel</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="text-center">
          ...
          <div className="bg-card/90 dark:bg-card/95 backdrop-blur-sm border border-border/50 dark:border-border/30 rounded-xl px-6 py-4 shadow-lg dark:shadow-xl">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <p className="text-foreground dark:text-foreground/95 font-medium">Loading duel...</p>
            </div>
            <p className="text-muted-foreground dark:text-muted-foreground/80 text-sm">Verifying shortcode</p>
          </div>
        </div>
      </div>
    );
            ...
            <div className="mb-8">
                        ...
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          {challengerWizard.wins || challengerWizard.losses ? (
                            ...
                            >
                              ...
                              {challengerWizard.wins || 0}W - {challengerWizard.losses || 0}L
                            </Badge>
                          ) : (
                            <Badge 
                              variant="secondary"
              ...
              <div className="mt-6 text-center">
                ...
                <p className="text-muted-foreground dark:text-muted-foreground/80 text-lg">
                  {challengerWizard.name} awaits your response to this magical duel
                </p>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-background/50 dark:bg-background/30 rounded-lg border border-border/30 dark:border-border/20">
                    ...
                    <Badge
                      variant={duel.status === "COMPLETED" ? "outline" : "default"}
                      className={
                  ...
                  <div className="flex items-center justify-between p-3 bg-background/50 dark:bg-background/30 rounded-lg border border-border/30 dark:border-border/20">
                    ...
                    <span className="font-medium text-foreground dark:text-foreground/95">{duel.players.length}</span>
                  </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="text-center p-3 bg-background/50 dark:bg-background/30 rounded-lg border border-border/30 dark:border-border/20">
                        <div className="flex items-center justify-center gap-2 mb-1">
                          ...
                          <span className="text-sm font-medium text-muted-foreground dark:text-muted-foreground/80">Type</span>
                        </div>
                      ...
                      <div className="text-center p-3 bg-background/50 dark:bg-background/30 rounded-lg border border-border/30 dark:border-border/20">
                        <div className="flex items-center justify-center gap-2 mb-1">
                          ...
                          <span className="text-sm font-medium text-muted-foreground dark:text-muted-foreground/80">Players</span>
                        </div>
                        <span className="font-semibold text-foreground dark:text-foreground/95">{duel.players.length}/2</span>
                      </div>
                      <div className="text-center p-3 bg-background/50 dark:bg-background/30 rounded-lg border border-border/30 dark:border-border/20">
                        <div className="flex items-center justify-center gap-2 mb-1">
                          <Calendar className="h-4 w-4 text-green-500 dark:text-green-400" />
                          <span className="text-sm font-medium text-muted-foreground dark:text-muted-foreground/80">Created</span>
                        </div>
                        <span className="font-semibold text-foreground dark:text-foreground/95">
